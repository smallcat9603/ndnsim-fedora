...
main (int argc, char *argv[])
{
  ...
  topologyReader.SetFileName ("src/ndnSIM/examples/topologies/topo-tree-huyao.txt");
  topologyReader.Read ();
  ...
  Ptr<Node> consumer = Names::Find<Node> ("n31");
  ...
  aggTracers = ndn::L3AggregateTracer::InstallAll ("aggregate-trace.txt", Seconds (0.02));

  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<ndn::L3RateTracer> > >
  rateTracers = ndn::L3RateTracer::InstallAll ("rate-trace.txt", Seconds (0.02));
    
  boost::tuple< boost::shared_ptr<std::ostream>, std::list<Ptr<L2RateTracer> > >
  l2tracers = L2RateTracer::InstallAll ("drop-trace.txt", Seconds (9.99999999));
